<div id="helloContainer" class="w-3/4 mx-auto">
...
<h3 class="mt-8 text-3xl font-extrabold text-gray-900">
    Bienvenue à l’AGEPAC !
</h3>
<p class="mt-1 font-medium text-gray-500">
    En tant que membre de l’AGEPAC, tu fais partie du plus grand réseau d’EPL.
</p>

<h4 class="mt-4 text-xl font-extrabold text-gray-900">
    Étapes suivantes
</h4>
