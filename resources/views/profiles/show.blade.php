        ...
        <div class="col-md-3 offset-md-0">
            ...
            <ul class="list-unstyled small font-weight-bold mx-4 mx-md-0">
                ...
                @unless(is_null($profileUser->flight_hours))
                    <li class="p-3 border-bottom">
                        <svg class="bi bi-stopwatch mr-2" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <li class="p-3 border-bottom">
                    <svg class="bi bi-phone mr-2" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <li class="p-3">
                    <svg class="bi bi-envelope mr-2" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
