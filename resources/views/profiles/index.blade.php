...
@section('content')
    <instant-search inline-template>
        <ais-instant-search :search-client="searchClient" index-name="profiles" :routing="routing">
                    ...
                    <div class="col-md-4 col-lg-3 offset-md-0 offset-lg-1">
                        ...
                        <div class="accordion" id="refinements">
                            <div class="collapse d-md-block" id="sortBy" data-parent="#refinements">
                                <ais-sort-by :items="[
                                { value: 'profiles', label: 'Nom ascendant' },
                            ]">
                            ...
                            <div class="collapse d-md-block" id="filterBy" data-parent="#refinements">
                                <ais-refinement-list attribute="class_course">
                                    <template #default="{items, canRefine, refine}">
                                        <x-linklist title="Filtrer par cursus" spacing="1" v-if="canRefine">
                                            <li v-for="item in items" :key="item.value" class="form-check">
                                                <label class="form-check-label"
                                ...
                                <ais-range-input attribute="class_year">
                                    <template #default="{currentRefinement, range, canRefine, refine}">
                                            <h4 class="h6 text-uppercase font-weight-bold text-gray-500" v-if="canRefine">
                                                Filter par promotion
                                            </h4>

                                            <div class="d-flex align-items-center mb-4" v-if="canRefine">
                                                <input type="number"
                                                       id="minClassYear"
                                ...
                                <ais-refinement-list attribute="mentorship_tags">
                                    <template #default="{items, canRefine, refine}">
                                        <x-linklist title="Filtrer par mentorat" spacing="1" v-if="canRefine">
                                            <li v-for="item in items" :key="item.value" class="form-check">
                                                <label class="form-check-label"
                                                       :class="{ 'font-weight-bolder': item.isRefined }">
                                                    <input type="checkbox"
                    ...
                    <div class="col-md-8 col-lg-7">
                        <ais-hits class="mt-md-n3">
                            <template #default="{ items }">
                                <profile-result v-for="profile in items"
