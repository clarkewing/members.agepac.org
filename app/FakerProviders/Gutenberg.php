...
{
    protected static $gutenbergPartList = [
    ...
    /**
     * Generate Wordpress Gutenberg compatible body.
     *
     * @param  int  $numberOfParts
     * @return string
     */
    public static function gutenberg($numberOfParts = 5)
    {
        return implode("\n\n", Arr::random(static::$gutenbergPartList, $numberOfParts));
    }
}
