...
class BestReplyTest extends TestCase
{
    ...
    public function testThreadCreatorCanMarkAnyReplyAsTheBestReply()
    {
        ...
        $this->postJson(route('replies.mark_best', [$replies[1]]));
    ...
    /** @test */
    public function testOnlyThreadCreatorMayUnmarkReplyAsBest()
    {
        $this->withExceptionHandling();
        $this->signIn();
        ...
        $this->deleteJson(route('replies.unmark_best', $replies[1]))
            ->assertStatus(403);
